        ...
        <NuxtLink to="/shoppingcart" class="flex items-center">
          ...
          >
            <div class="min-w-[40px] relative">
              ...
              />
              <span
                class="absolute flex items-center justify-center -top-2 -right-2 bg-[#FF4646] h-[17px] min-w-[17px] text-xs text-white px-0.5 rounded-full"
              >
